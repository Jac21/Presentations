	...
	c = function ()
	{
		...
		return r = {
			buttons:
			{
				...
				ok: '<button type="button" class="btn alertify-button alertify-button-ok" id="alertify-ok">{{ok}}</button>',
				//ok: '<button class="alertify-button alertify-button-ok" id="alertify-ok">{{ok}}</button>',
				cancel: '<button type="button" class="btn alertify-button alertify-button-cancel" id="alertify-cancel">{{cancel}}</button>'
			},
			input: '<div class="alertify-text-wrapper"><input type="text" placeholder=\"Email Address\" class="alertify-text" id="alertify-text"></div>',
